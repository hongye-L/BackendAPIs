...
public class RedisUtil {
    ...
    public void set(final String key,Object value){
        final byte[] bytes= com.hongye.APIsOfMyBatis.Util.SerializeUtil.serialize(value);
    ...
    public void set(final String key, Object value, final long l) {
        final byte[] vbytes = com.hongye.APIsOfMyBatis.Util.SerializeUtil.serialize(value);
        redisTemplate.execute(new RedisCallback<Object>() {
            @Override
        ...
        return redisTemplate.execute(new RedisCallback<T>() {
            ...
            public T doInRedis(RedisConnection redisConnection)throws  DataAccessException{
                ...
                if (redisConnection.exists(bytes)){
                    ...
                    T values=(T) com.hongye.APIsOfMyBatis.Util.SerializeUtil.deserialize(value);
                    return values;
                }
                return null;
            }
